# ROS 2 SLAM × Navigation2 接続教材

SLAMアルゴリズムの数式ではなく，センサー，Odometry，TF，SLAM，Localization，Navigation2，ロボット制御をROS 2上で接続する仕組みを学ぶオフラインHTML教材です．
...
フォルダ構成のまま使う場合は，`index.html`を開いてください．
